<template>
    <div class="login">
        <form class="form">
            ...
            <br>
            <input class="form-control" type="pass" id="pass" placeholder="Contraseña" v-model="con1" required />
            <br>
            <input class="form-control" type="pass" id="pass" placeholder="Repite la contraseña" v-model="con2" required/>
            <div class="col" >
                <label v-show="error != false">Contraseña no es la misma</label>
